...
Elm.Bootstrap.Html.make = function (_elm) {
   ...
   lgOffset) {
      return $Html$Shorthand.div$({_: {}
                                  ,$class: A2($Basics._op["++"],
                                  A3($Bootstrap$Html$Internal.colOffset,
                                  "xs",
                                  xs,
                                  xsOffset),
                                  A2($Basics._op["++"],
   ...
   var colSmOffset_ = F4(function (xs,
   xsOffset,
   sm,
   smOffset) {
      return $Html$Shorthand.div$({_: {}
   ...
   var colXsOffset_ = F2(function (xs,
   xsOffset) {
      return $Html$Shorthand.div$({_: {}
                                  ,$class: A3($Bootstrap$Html$Internal.colOffset,
                                  "xs",
                                  xs,
                                  xsOffset)});
   });
...
Elm.Bootstrap.Html.Internal.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var colOffset = F3(function (gridsize,
   colspan,
   offset) {
      return function () {
               ...
               {case "_Tuple2":
                  switch (_v10._0.ctor)
                    {case "Just":
                       switch (_v10._1.ctor)
                         {case "Just":
                            return _L.fromArray([_v10._0._0
                                                ,$Html.text(A2($String.cons,
                                                _U.chr(" "),
                                                _v10._1._0))]);}
                         return _L.fromArray([_v10._0._0]);}
                    switch (_v10._1.ctor)
                    {case "Just":
                       return _L.fromArray([$Html.text(_v10._1._0)]);}
                    break;}
               return _L.fromArray([]);
            }());
         }();
...
Elm.Client.make = function (_elm) {
   ...
   model) {
      ...
      _L.fromArray([$Bootstrap$Html.containerFluid_(_L.fromArray([$Bootstrap$Html.navbarHeader_(_L.fromArray([A2($Html$Shorthand.a$,
                                                                 ...
                                                                 _L.fromArray([$Html$Shorthand.li_(_L.fromArray([A2($Html.a,
                                                                              _L.fromArray([$Html$Attributes.$class("active")
                                                                                           ,$Html$Attributes.href("#/page1")
                                                                                           ,A2($Html$Events.onClick,
                                                                                           addr,
                                                                                           NavPage1)]),
                                                                              _L.fromArray([$Html.text("Page 1")]))]))
                                                                              ,$Html$Shorthand.li_(_L.fromArray([A2($Html.a,
                                                                              _L.fromArray([$Html$Attributes.$class("")
                                                                                           ,$Html$Attributes.href("#/page2")
                                                                                           ,A2($Html$Events.onClick,
                                                                                           addr,
                                                                                           NavPage2)]),
   ...
   var initialModel = {_: {}
                      ,page: _U.eq(A2($Debug.log,
                      "loc:",
                      initialLocation),
                      "") ? "page1" : initialLocation};
